...
?>
  ...
  <tr bgcolor="#FFFFFF"> 
    <td height="22" valign="top"><strong>资讯内容正则：</strong><br>
      (<input name="textfield" type="text" id="textfield" value="[!--texts--]" size="20">)</td>
    <td><table width="100%" border="0" cellspacing="1" cellpadding="3">
        <tr> 
          <td><textarea name="add[zz_texts]" cols="60" rows="10" id="textarea"><?=ehtmlspecialchars(stripSlashes($r[zz_texts]))?></textarea></td>
        </tr>
        <tr> 
          <td><input name="add[z_texts]" type="text" id="add[z_texts]" value="<?=stripSlashes($r[z_texts])?>">
            (如填写这里，将为字段的值)</td>
        </tr>
      </table></td>
  </tr>
