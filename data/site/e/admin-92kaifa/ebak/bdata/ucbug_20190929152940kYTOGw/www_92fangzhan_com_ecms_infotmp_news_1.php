...
E_D("DROP TABLE IF EXISTS `www_92fangzhan_com_ecms_infotmp_news`;");
E_C("CREATE TABLE `www_92fangzhan_com_ecms_infotmp_news` (
  ...
  `xzlj` mediumtext NOT NULL,
  `bibei` varchar(255) NOT NULL DEFAULT '',
  PRIMARY KEY (`id`),
  KEY `classid` (`classid`),
  KEY `checked` (`checked`)
