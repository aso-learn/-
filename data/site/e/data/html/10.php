...
?><table width='100%' align=center cellpadding=3 cellspacing=1 bgcolor='#DBEAF5'><tr><td width='16%' height=25 bgcolor='ffffff'>图书名称</td><td bgcolor='ffffff'><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#DBEAF5">
<tr> 
...
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>书本图片</td><td bgcolor='ffffff'><input name="titlepic" type="text" id="titlepic" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[titlepic]))?>" size="45">
...
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>一级分类</td><td bgcolor='ffffff'>
<input name="category1" type="text" id="category1" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[category1]))?>" size="">
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>二级分类</td><td bgcolor='ffffff'>
<input name="category2" type="text" id="category2" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[category2]))?>" size="">
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>三级分类</td><td bgcolor='ffffff'>
<input name="category3" type="text" id="category3" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[category3]))?>" size="">
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>四级分类</td><td bgcolor='ffffff'>
<input name="category4" type="text" id="category4" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[category4]))?>" size="">
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>五级分类</td><td bgcolor='ffffff'>
<input name="category5" type="text" id="category5" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[category5]))?>" size="">
...
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>简介</td><td bgcolor='ffffff'>
