...
/********密码验证***********/
$password='5188aaaa99921';				                   //这个密码是登陆验证用的.您需要在模块里设置和这里一样的密码....注意一定需要修改.
...
$_POST[morepic]=str_replace('<img src="','',$_POST[morepic]); //替换字符
$_POST[morepic]=str_replace('" >','',$_POST[morepic]); //替换字符


$morepic = explode("|||",$_POST['morepic']);
$i = 0;
foreach ($morepic as $shuzu=>$str){
    $i = $i + 1;
	$_POST['msmallpic'][] = $str;
	$_POST['mbigpic'][] = $str;
	$_POST['mpicname'][] = $_POST['title'];
	$_POST['mpicid'][] = $i;
}
