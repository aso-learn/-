...
E_D("DROP TABLE IF EXISTS `www_92fangzhan_com_ecms_infoclass_article`;");
E_C("CREATE TABLE `www_92fangzhan_com_ecms_infoclass_article` (
  ...
  `zz_texts` text NOT NULL,
  `z_texts` varchar(255) NOT NULL,
  `qz_texts` varchar(255) NOT NULL,
  `save_texts` varchar(10) NOT NULL,
  PRIMARY KEY (`classid`)
