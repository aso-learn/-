...
E_D("DROP TABLE IF EXISTS `www_92fangzhan_com_enewspublic`;");
E_C("CREATE TABLE `www_92fangzhan_com_enewspublic` (
  ...
  `baktempnum` int(4) NOT NULL DEFAULT '0',
