...
//数据库设置
$ecms_config['db']['usedb']='<!--dbtype.phome.net-->';	//数据库类型
$ecms_config['db']['dbver']='<!--dbver.phome.net-->';	//数据库版本
$ecms_config['db']['dbserver']='<!--host.phome.net-->';	//数据库登录地址
$ecms_config['db']['dbport']='<!--port.phome.net-->';	//端口，不填为按默认
$ecms_config['db']['dbusername']='<!--username.phome.net-->';	//数据库用户名
$ecms_config['db']['dbpassword']='<!--password.phome.net-->';	//数据库密码
$ecms_config['db']['dbname']='<!--name.phome.net-->';	//数据库名
$ecms_config['db']['setchar']='<!--char.phome.net-->';	//设置默认编码
$ecms_config['db']['dbchar']='<!--dbchar.phome.net-->';	//数据库默认编码
$ecms_config['db']['dbtbpre']='<!--tbpre.phome.net-->';	//数据表前缀
$dbtbpre=$ecms_config['db']['dbtbpre'];	//数据表前缀
$ecms_config['db']['showerror']=1;	//显示SQL错误提示(0为不显示,1为显示)


//页面编码设置
$ecms_config['sets']['pagechar']='<!--headerchar.phome.net-->';	//安装帝国CMS的编码版本
