...
elseif($enews=='register' || $enews=='phoneRegister')
{
...
elseif($enews=='SendPassword'||$enews=='SendPasswordB'||$enews=='DoGetPassword'||$enews=='DoActUser'||$enews=='RegSend')
{
...
elseif($enews=="phoneRegister")//手机注册
{
    phoneRegister($_POST);
}
...
elseif($enews=='SendPasswordB')//发送取回密码邮件
{
    SendGetPasswordPhone($_POST);
}
