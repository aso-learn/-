...
$ecms_config['esafe']['ecookiernd']='bnjAYQBiTCt5P9bLyyctUqmRoQLGQlfUyqth';	//后台登录COOKIE认证码(填写10~50个任意字符，最好多种字符组合)
...
$ecms_config['cks']['ckvarpre']='cysry';		//前台cookie变量前缀
$ecms_config['cks']['ckadminvarpre']='grdof';		//后台cookie变量前缀
$ecms_config['cks']['ckrnd']='zuIyRZ9RsbqwwkZXxLrdgd5ojsUmhkT0hFM';	//COOKIE验证随机码(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndtwo']='5cCkk24Dzmrpk42dh9HS09RCNoZUju4i5k';	//COOKIE验证随机码2(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndthree']='cy7BfIJhEvk8P5kBvITGvHyDunkS5tM9T';	//COOKIE验证随机码3(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndfour']='UNlofqLPv7iy3CGmJK8vP1ZMDiqKpxD8';	//COOKIE验证随机码4(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndfive']='I32dEdtce6zSQOLBAEggSjer1QZg31W';	//COOKIE验证随机码5(填写10~50个任意字符，最好多种字符组合)
...
'keytog'=>2,
'keytime'=>30,
'keyrnd'=>'x55gb9wkouwUVep1F4vhyo0j2srrlhIU',
...
'bakescapetype'=>1,
'hkeytime'=>30,
'hkeyrnd'=>'CcHLCsVEFZmysEFgNQW1JbBjUhYxl2YNkQOU',
'mhavedatedo'=>0,
'reportkey'=>0,
'ctimeopen'=>0,
'ctimelast'=>0,
...
'ctimegids'=>'',
'ctimecids'=>'',
'ctimernd'=>'QINI5EkiRZqStazO7KJhUa4eysFrIEGQAZEjBbbZha',
'qmadminuids'=>'',
'qmforumuids'=>'',
'qmotheruids'=>'',
'ckhavemoreport'=>0,
