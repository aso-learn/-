...
$ecms_config['esafe']['ecookiernd']='IQbLLRwuDS1sfAzljZCs5EurKcbx1jwNwvY7';	//后台登录COOKIE认证码(填写10~50个任意字符，最好多种字符组合)
...
$ecms_config['cks']['ckvarpre']='doqby';		//前台cookie变量前缀
$ecms_config['cks']['ckadminvarpre']='wadjm';		//后台cookie变量前缀
$ecms_config['cks']['ckrnd']='qvsbZP5QCcKvacglCRqnXPnkSSQ2kutmXzu';	//COOKIE验证随机码(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndtwo']='eEVLDCWjOcTRGELdlnmjBa0EzEjpfBQ5UP';	//COOKIE验证随机码2(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndthree']='JKFwF4VV4gO4fdSKCInB7VEeBAvUjhR4T';	//COOKIE验证随机码3(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndfour']='bU3eCBcVNJwAEs1enrYcuoudbWiZINFm';	//COOKIE验证随机码4(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndfive']='eUDOIfDtCSBAH9A8cUULuWzVj7Sra00';	//COOKIE验证随机码5(填写10~50个任意字符，最好多种字符组合)
